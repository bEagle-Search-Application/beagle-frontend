...
export const ExtraCard: FC<Props> = ({ title, description, author }) => (
  <div className='max-w-[21.625rem] rounded-2xl bg-neutral-100 border-[1px] border-neutral-300'>
    <div className='p-8 flex flex-col justify-center items-center gap-8'>
      <div className='flex justify-center'>
        ...
        <img
          ...
          alt='Img'
          className='max-w-[9rem] h-[9rem] rounded-full object-cover'
        />
      ...
      <div>
        <h6 className='text-neutral-900 text-[1.25rem] leading-6 font-bold'>
          {title}
        </h6>
      </div>
      <div>
